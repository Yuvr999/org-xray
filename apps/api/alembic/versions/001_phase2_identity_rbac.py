"""001_phase2_identity_rbac

Revision ID: 001_phase2_identity_rbac
Revises: 
...
revision: str = '001_phase2_identity_rbac'
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column('primary_role', sa.String(length=50), nullable=False, server_default='employee'),
        sa.Column('is_active', sa.Boolean(), nullable=False, server_default='true'),
